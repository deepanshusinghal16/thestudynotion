...
const Spinner = () => {
    return (
        ...
        // <div classNameName="flex items-center flex-col  text-center text-[3rem] md:text-[5rem] lg:text-[6rem] justify-center h-[90vh]   ">
        //     <div classNameName='spinner'></div>
        //     <span classNameName='waviy text-richblack-100'>Loading...</span>
        // </div>

        <div className='h-[88vh] w-full items-center justify-center flex'>
