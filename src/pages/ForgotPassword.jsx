...
const ForgotPassword = () => {
    ...
    return (
        <div className='w-10/12 mx-auto flex items-center justify-center mt-40 text-richblack-5'>
                                ...
                                !emailSent && (
                                    <label>
                                        ...
                                        <input type="email" required name='email' value={email} onChange={(e) => setEmail(e.target.value)}
                                            placeholder='Enter your Email ' className='bg-richblack-900 border-2 border-richblack-400 rounded-lg px-2 w-full' />
                                    </label>
                                )
                            }
                            <br />
